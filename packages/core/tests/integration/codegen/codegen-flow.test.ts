...
import { SchemaRegistry } from '@/codegen/registry.js';
import type { ContentTypeDefinition } from '@/codegen/types/schema.js';

// Inference
import { inferSchemaFromStore } from '@/codegen/inference/from-store.js';
import { inferSchemaFromResponse } from '@/codegen/inference/from-response.js';

// Generators
import { TypeScriptGenerator } from '@/codegen/generators/typescript.js';
import { TypeGuardGenerator } from '@/codegen/generators/type-guards.js';
import { FetchHelperGenerator } from '@/codegen/generators/fetch-helpers.js';

// Output
import { FileWriter } from '@/codegen/output/file-writer.js';
...
describe('End-to-end codegen flow', () => {
  ...
  describe('Generated code quality', () => {
    ...
    it('should generate correct fetch helpers', () => {
      ...
      // Verify helpers use graphqlFetch
