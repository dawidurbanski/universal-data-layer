...
describe('createDefaultWebhookHandler', () => {
  ...
  describe('upsert operation', () => {
    it('should create a new node', async () => {
      ...
      expect((node as Record<string, unknown>).title).toBe('Test Product');
      expect((node as Record<string, unknown>).price).toBe(99);
    });
    ...
    it('should update an existing node', async () => {
      ...
      expect(res.getStatusCode()).toBe(200);
      const node = store.get('product-1');
      expect((node as Record<string, unknown>).title).toBe('Updated');
    });
  });
  ...
  describe('update operation', () => {
    it('should update an existing node', async () => {
      ...
      expect((node as Record<string, unknown>).name).toBe('Updated');
    });
  ...
  describe('idField option', () => {
    it('should find nodes by custom field for update', async () => {
      ...
      expect((node as Record<string, unknown>).title).toBe('Updated Title');
    });
    ...
    it('should create nodes with generated internal ID when using idField', async () => {
      ...
      expect(node).toBeDefined();
      expect((node as Record<string, unknown>).name).toBe('New Product');
    });
    ...
    it('should upsert existing nodes found by idField', async () => {
      ...
      expect((node as Record<string, unknown>).value).toBe(200);
    });
  });
});
